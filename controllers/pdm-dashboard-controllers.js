...
exports.readtotalasset = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT COUNT(*) AS total FROM mst_device;", {
...
exports.readtotalassetoci1 = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT COUNT(*) AS total FROM mst_device d JOIN view_area a ON a.id_area = d.id_area WHERE a.name_area = 'OCI1';", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.readassetoci1 = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT * FROM mst_device d JOIN view_area a ON a.id_area = d.id_area WHERE a.name_area = 'OCI1';", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.readtotalassetoci2 = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT COUNT(*) AS total FROM mst_device d JOIN view_area a ON a.id_area = d.id_area WHERE a.name_area = 'OCI2';", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.readassetoci2 = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT * FROM mst_device d JOIN view_area a ON a.id_area = d.id_area WHERE a.name_area = 'OCI2';", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.readtotalassetfsb = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT COUNT(*) AS total FROM mst_device d JOIN view_area a ON a.id_area = d.id_area WHERE a.name_area = 'FSB' OR a.name_area = 'SBK1';", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.readassetfsb = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT * FROM mst_device d JOIN view_area a ON a.id_area = d.id_area WHERE a.name_area = 'SBK1';", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.vibrationlineoci1 = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT t.do_date,t.value,t.device_name,t.test_name FROM mst_history t WHERE t.area_name = 'OCI1' AND t.kategori = 'vibration' GROUP BY t.device_name,t.do_date,t.test_name,t.PIC ORDER BY t.do_date ASC;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.vibrationlineoci2 = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT t.do_date,t.value,t.device_name,t.test_name FROM mst_history t WHERE t.area_name = 'OCI2' AND t.kategori = 'vibration' GROUP BY t.device_name,t.do_date,t.test_name,t.PIC ORDER BY t.do_date ASC;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.vibrationlinefsb = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT t.do_date,t.value,t.device_name,t.test_name FROM mst_history t WHERE (t.area_name = 'FSB' OR t.area_name = 'SBK1') AND t.kategori = 'vibration' GROUP BY t.device_name,t.do_date,t.test_name,t.PIC ORDER BY t.do_date ASC;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.amperelineoci1 = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT t.do_date,t.value,t.device_name,t.test_name FROM mst_history t WHERE t.area_name = 'OCI1' AND t.kategori = 'ampere' GROUP BY t.device_name,t.do_date,t.test_name,t.PIC ORDER BY t.do_date ASC;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.amperelineoci2 = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT t.do_date,t.value,t.device_name,t.test_name FROM mst_history t WHERE t.area_name = 'OCI2' AND t.kategori = 'ampere' GROUP BY t.device_name,t.do_date,t.test_name,t.PIC ORDER BY t.do_date ASC;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.amperelinefsb = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT t.do_date,t.value,t.device_name,t.test_name FROM mst_history t WHERE (t.area_name = 'FSB' OR t.area_name = 'SBK1') AND t.kategori = 'ampere' GROUP BY t.device_name,t.do_date,t.test_name,t.PIC ORDER BY t.do_date ASC;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.temperaturelineoci1 = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT t.do_date,t.value,t.device_name,t.test_name FROM mst_history t WHERE t.area_name = 'OCI1' AND t.kategori = 'temperature' GROUP BY t.device_name,t.do_date,t.test_name,t.PIC ORDER BY t.do_date ASC;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.temperaturelineoci2 = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT t.do_date,t.value,t.device_name,t.test_name FROM mst_history t WHERE t.area_name = 'OCI2' AND t.kategori = 'temperature' GROUP BY t.device_name,t.do_date,t.test_name,t.PIC ORDER BY t.do_date ASC;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.temperaturelinefsb = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT t.do_date,t.value,t.device_name,t.test_name FROM mst_history t WHERE (t.area_name = 'FSB' OR t.area_name = 'SBK1') AND t.kategori = 'temperature' GROUP BY t.device_name,t.do_date,t.test_name,t.PIC ORDER BY t.do_date ASC;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.oci1fnotfinish = async (req, res) => {
    try {
        const get = await config.connectPdm.query(`SELECT a.name_area,a.id_child,t.value, st.id_set_test, d.device_name, t.plan_date, MONTH(t.plan_date) AS month, YEAR(t.plan_date) AS year
        FROM tr_test t 
...
exports.oci1valuepermonth = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT DATE_FORMAT(h.do_date,'%M') AS bulan,h.device_name FROM mst_history h WHERE h.area_name = 'OCI1' AND h.do_date BETWEEN date(date_format(CURDATE(),'%Y-01-01')) AND CURRENT_TIMESTAMP GROUP BY h.device_name,h.do_date;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.oci2valuepermonth = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT DATE_FORMAT(h.do_date,'%M') AS bulan,h.device_name FROM mst_history h WHERE h.area_name = 'OCI2' AND h.do_date BETWEEN date(date_format(CURDATE(),'%Y-01-01')) AND CURRENT_TIMESTAMP GROUP BY h.device_name,h.do_date;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
...
exports.fsbvaluepermonth = async (req, res) => {
    try {
        const get = await config.connectPdm.query("SELECT DATE_FORMAT(h.do_date,'%M') AS bulan,h.device_name FROM mst_history h WHERE h.area_name = 'SBK1' AND h.do_date BETWEEN date(date_format(CURDATE(),'%Y-01-01')) AND CURRENT_TIMESTAMP GROUP BY h.device_name,h.do_date;", {
            type: Sequelize.QueryTypes.SELECT
        });
        return res.status(200).json({
            get
